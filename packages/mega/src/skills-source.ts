...
export const NO_SKILLS_SOURCE: undefined = undefined

/** Validate a raw row config value; absent/unknown kinds mean "no external source". */
export function normalizeSkillsSource(input: unknown): SkillsSourceConfig | undefined {
...
export class SkillSource {
  constructor(private readonly config: SkillsSourceConfig | undefined) {}
