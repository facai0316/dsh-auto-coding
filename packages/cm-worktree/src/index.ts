...
function defaultWorktreeRoot(repo: string): string {
...
export class WorktreeManager {
   ...
   */
  linkSharedTarget(handle: WorktreeHandle, targetDir = 'target'): void {
  ...
  private git(args: string[], cwd?: string): string {
    try {
      ...
      const err = error as { stderr?: string | Buffer | null; message?: string }
