...
import { STAGES, WorkerPipeline, parsePrResult, stageWindowAllowed, withinWindow, type ClaimedRequirement, type PipelineWorktree, type PrExecution, type StageAgentOptions, type StageExecution, type StageInput } from './pipeline.ts'
export { buildResolvePrompt, buildPrompt, buildPrPrompt, runLanes, stageWindowAllowed, withinWindow, WorkerPipeline, type GapRow } from './pipeline.ts'
...
/**
 * 时段门控（见 pipeline.ts）：withinWindow 判窗口（start>end 跨天，如
